...
void Genotype::ret_dev_process(const double alpha, const int round,
  const double env_cue, std::vector<std::vector<double>>& dev_process) const{

  dev_process.clear();
  std::vector<double> p_vec(genotype);
  dev_process.push_back(p_vec);
...
std::vector<double> Genotype::ret_dev_random(const double alpha, const int round,
  const double env_cue, const std::vector<double>& rand_genotype) const{

  std::vector<double> p_vec(rand_genotype);
