...
public:
  ...
  void ret_dev_process(const double alpha, const int round, const double env_cue,
    std::vector<std::vector<double>>& dev_process) const;
  std::vector<double> ret_dev_random(const double alpha, const int round,
