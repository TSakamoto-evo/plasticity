...
void Genotype::return_all_indices(int& ret_pop_size,
  std::vector<int>& ret_mut_genotype,
  std::vector<std::vector<int>>& ret_mut_interactions,
  std::vector<int>& ret_mut_env_effects) const{

  ret_pop_size = ind_num;
  ret_mut_genotype = mut_genotype;
  ret_mut_interactions = mut_interactions;
  ret_mut_env_effects = mut_env_effects;
}
